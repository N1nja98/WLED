...
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><head><meta name="viewport" content="width=500"><meta 
charset="utf-8"><title>Misc Settings</title><script>
function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#security-settings")}function B(){window.open("/settings","_self")}function U(){window.open("/update","_self")}function GetV(){}
</script><style>@import url("style.css");</style></head><body onload="GetV()">
...
Turn on Clock: <input type="checkbox" name="TOC"><br>
Dim lights when turned off: <input type="checkbox" name="DL"><br>
Dimmed brightness: <input id="dim_brightness" name="DB" type="number" min="0" 
max="255" required=""><br>Clock Hex Color: <input id="clock_color" 
maxlength="9" name="CHC"><br><hr><button type="button" onclick="B()">Back
